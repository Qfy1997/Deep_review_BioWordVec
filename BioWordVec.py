'''
深度理解代码层面的BioWordVec
这份代码需要numpy的版本为1.19的时候才能跑通，高于这个版本会报错。
'''
#coding=utf-8
...
def main(args):
	...
	# f_pkl.close()
	# print(len(mesh_dict.keys()))

	# 调用networkx去加载MeSH_graph.edgelist这个文件。
	G = nx.read_edgelist(args.input_mesh, nodetype=str, create_using=nx.DiGraph())
	# 通过这个段代码可以先看看G.edges()里面东西是什么。
	# for edge in G.edges():
	# 	print(edge)
	# 	break
	...
	#args.num_walks 2, args.walk_length 50
